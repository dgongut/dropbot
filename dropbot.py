...
DOWNLOAD_PATHS = {
    "audio": DEFAULT_DOWNLOAD_PATH if not DEFAULT_DOWNLOAD_AUDIO else DEFAULT_DOWNLOAD_AUDIO,
    "video": DEFAULT_DOWNLOAD_PATH if not DEFAULT_DOWNLOAD_VIDEO else DEFAULT_DOWNLOAD_VIDEO,
    "photo": DEFAULT_DOWNLOAD_PATH if not DEFAULT_DOWNLOAD_PHOTO else DEFAULT_DOWNLOAD_PHOTO,
    "document": DEFAULT_DOWNLOAD_PATH if not DEFAULT_DOWNLOAD_DOCUMENT else DEFAULT_DOWNLOAD_DOCUMENT,
    "torrent": DEFAULT_DOWNLOAD_PATH if not DEFAULT_DOWNLOAD_TORRENT else DEFAULT_DOWNLOAD_TORRENT
}
